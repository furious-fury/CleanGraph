...
const cleanverseCountryCodes = new Set([
  ...
  "BO", "BR", "BS", "BT", "BW", "BY", "BZ", "CA", "CF", "CG",
  "CH", "CL", "CM", "CN", "CO", "CR", "CU", "CV", "CY", "CZ",
  ...
  "PS", "PT", "PW", "PY", "QA", "RO", "RS", "RU", "RW", "SA",
  "SB", "SC", "SD", "SE", "SG", "SI", "SK", "SL", "SM", "SN",
  "SO", "SR", "SS", "ST", "SV", "SY", "TD", "TG", "TH", "TJ",
  "TL", "TM", "TN", "TO", "TR", "TT", "TV", "TW", "TZ", "UA",
  "UG", "US", "UY", "UZ", "VA", "VC", "VE", "VN", "VU", "WS",
  "YE", "ZA", "ZM", "ZW",
]);

export const cleanverseCountryCodeSchema = z
  .string()
  .refine((value) => cleanverseCountryCodes.has(value), {
    message: "Country must be an uppercase Cleanverse ISO country code",
  });

export type CleanverseCountryCode = z.infer<
  typeof cleanverseCountryCodeSchema
>;
